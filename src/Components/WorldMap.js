...
class WorldMap extends Component {
  ...
  projection = () => {
    return geoOrthographic() // the type of map
      .scale(400) // how big or small it is
  ...
  render() {
    // this.projection.fitExtent([[0, 0], [900, 500]], geojson);
    const countries = this.state.worlddata.map((d, i) => {
      return (
        <path
          ...
          stroke='#FFFFFF'
          strokeWidth={.5} // outline of the countries
